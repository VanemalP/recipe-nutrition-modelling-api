...
export class newMigration1562132988322 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query("CREATE TABLE `subrecipe` (`id` varchar(36) NOT NULL, `quantity` int NOT NULL DEFAULT 0, `unit` varchar(255) NOT NULL, `linkedRecipeId` varchar(36) NULL, `recipeId` varchar(36) NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB");
        await queryRunner.query("CREATE TABLE `recipes` (`id` varchar(36) NOT NULL, `title` varchar(255) NOT NULL, `imageURL` varchar(255) NOT NULL, `notes` longtext NOT NULL, `amount` int NOT NULL, `Created` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `authorId` varchar(36) NULL, `nutritionId` varchar(36) NULL, UNIQUE INDEX `REL_642147e73deda7e94f8fa87c5b` (`nutritionId`), PRIMARY KEY (`id`)) ENGINE=InnoDB");
        ...
        await queryRunner.query("CREATE TABLE `recipes_food_groups_food_groups` (`recipesId` varchar(36) NOT NULL, `foodGroupsCode` int NOT NULL, INDEX `IDX_8ef258b306d892c64d3d4be30b` (`recipesId`), INDEX `IDX_8a0b1726a6bbf539610f32ee02` (`foodGroupsCode`), PRIMARY KEY (`recipesId`, `foodGroupsCode`)) ENGINE=InnoDB");
        ...
        await queryRunner.query("ALTER TABLE `recipes_food_groups_food_groups` ADD CONSTRAINT `FK_8ef258b306d892c64d3d4be30b1` FOREIGN KEY (`recipesId`) REFERENCES `recipes`(`id`) ON DELETE CASCADE ON UPDATE NO ACTION");
        await queryRunner.query("ALTER TABLE `recipes_food_groups_food_groups` ADD CONSTRAINT `FK_8a0b1726a6bbf539610f32ee02b` FOREIGN KEY (`foodGroupsCode`) REFERENCES `food_groups`(`code`) ON DELETE CASCADE ON UPDATE NO ACTION");
    }

    public async down(queryRunner: QueryRunner): Promise<any> {
        await queryRunner.query("ALTER TABLE `recipes_food_groups_food_groups` DROP FOREIGN KEY `FK_8a0b1726a6bbf539610f32ee02b`");
        await queryRunner.query("ALTER TABLE `recipes_food_groups_food_groups` DROP FOREIGN KEY `FK_8ef258b306d892c64d3d4be30b1`");
        ...
        await queryRunner.query("DROP INDEX `IDX_8a0b1726a6bbf539610f32ee02` ON `recipes_food_groups_food_groups`");
        await queryRunner.query("DROP INDEX `IDX_8ef258b306d892c64d3d4be30b` ON `recipes_food_groups_food_groups`");
        await queryRunner.query("DROP TABLE `recipes_food_groups_food_groups`");
