...
export class Initial1562217112096 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query("CREATE TABLE `recipes` (`id` varchar(36) NOT NULL, `title` varchar(255) NOT NULL, `imageURL` varchar(255) NOT NULL DEFAULT 'https://images.all-free-download.com/images/graphiclarge/healthy_meal_background_vegetables_eggs_bacon_icons_6836169.jpg', `notes` longtext NOT NULL DEFAULT '', `measure` varchar(255) NOT NULL DEFAULT 'g', `amount` int NOT NULL DEFAULT 0, `Created` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `authorId` varchar(36) NULL, `nutritionId` varchar(36) NULL, UNIQUE INDEX `REL_642147e73deda7e94f8fa87c5b` (`nutritionId`), PRIMARY KEY (`id`)) ENGINE=InnoDB");
