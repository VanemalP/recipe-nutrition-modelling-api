...
export class initial1563378958837 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query("CREATE TABLE `ingredients` (`id` varchar(36) NOT NULL, `quantity` decimal NOT NULL DEFAULT 0, `unit` varchar(255) NOT NULL, `isDeleted` tinyint NOT NULL DEFAULT 0, `productCode` int NULL, `recipeId` varchar(36) NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB");
        ...
        await queryRunner.query("CREATE TABLE `subrecipe` (`id` varchar(36) NOT NULL, `quantity` decimal NOT NULL DEFAULT 0, `unit` varchar(255) NOT NULL, `isDeleted` tinyint NOT NULL DEFAULT 0, `linkedRecipeId` varchar(36) NULL, `recipeId` varchar(36) NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB");
        await queryRunner.query("CREATE TABLE `recipes` (`id` varchar(36) NOT NULL, `title` varchar(255) NOT NULL, `imageURL` varchar(255) NOT NULL DEFAULT 'https://images.all-free-download.com/images/graphiclarge/healthy_meal_background_vegetables_eggs_bacon_icons_6836169.jpg', `notes` longtext NOT NULL DEFAULT '', `measure` varchar(255) NOT NULL DEFAULT '1 g', `amount` decimal NOT NULL DEFAULT 0, `created` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `isDeleted` tinyint NOT NULL DEFAULT 0, `authorId` varchar(36) NULL, `categoryName` varchar(255) NULL, `nutritionId` varchar(36) NULL, UNIQUE INDEX `REL_642147e73deda7e94f8fa87c5b` (`nutritionId`), PRIMARY KEY (`id`)) ENGINE=InnoDB");
